 ...
 */
export async function recordAccountCreationBaseline(userId) {
 ...
 */
export async function applyServiceCompletionTrust(userId) {
 ...
 */
export async function applyListingRejectionTrust(userId, rejectionCount) {
    if (rejectionCount === 2) {
 ...
 */
export async function getTrustHistory(userId) {
