...
router.post("/", auth_middleware_1.requireVerification, offers_controller_1.create);
...
router.patch("/:id/accept", auth_middleware_1.requireVerification, offers_controller_1.accept);
