...
async function main() {
    ...
    // 6b. Seed Public Service Requests & Offers for Juan Seeker
    const req1 = await prisma.serviceRequest.create({
        data: {
            id: "req_juan_1",
            seekerId: dualUser.id,
            categoryId: plumbing.id,
            title: "Emergency Pipe Leak Repair in Kitchen",
            description: "Main sink supply pipe burst under counter top. Need urgent repair before water damage spreads.",
            budgetMin: 500.00,
            budgetMax: 1200.00,
            urgency: "high",
            status: "OPEN"
    ...
    await prisma.offer.create({
        data: {
            ...
            message: "I have heavy-duty pipe sealing tools and replacement PVC fittings ready in Bangbang, Cordova.",
            status: "PENDING"
        }
    });
    await prisma.serviceRequest.create({
        data: {
            ...
            title: "Circuit Breaker Tripping & Outlet Diagnostics",
            description: "Breaker switch keeps flipping whenever air conditioner is powered on. Need qualified technician to inspect main box.",
            budgetMin: 400.00,
            budgetMax: 800.00,
            urgency: "medium",
            status: "OPEN"
    ...
    await prisma.serviceRequest.create({
        data: {
            ...
            title: "Full House Deep Cleaning & Outdoor Pressure Washing",
            description: "General deep clean needed before family gathering, including window glass wipedown and patio cleaning.",
            budgetMin: 800.00,
            budgetMax: 1600.00,
            urgency: "low",
            status: "OPEN"
    ...
    console.log("✅ Seeded 3 Public Service Requests with Provider Offer for Juan Seeker");
