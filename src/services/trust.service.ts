 ...
 */
export async function applyCancellationTrust(userId: string, isProvider: boolean): Promise<void> {
 ...
 */
export async function applyListingRejectionTrust(userId: string, count: number): Promise<void> {
  if (count === 2) {
